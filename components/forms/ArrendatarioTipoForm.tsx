...
export function ArrendatarioTipoForm({ onSubmit }: { onSubmit: (data: any) => void }) {
  ...
  const formJuridico = (
    <>
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-xl font-heading font-semibold">Datos del Arrendatario (Persona Jurídica)</h2>
      </div>
      
      <div className="grid md:grid-cols-2 gap-4">
        <div>
          <Label>Razón Social (Arrendatario)<span className="text-red-500">*</span></Label>
          <Input required name="razonSocial" onChange={e => setForm((f: any) => ({ ...f, razonSocial: e.target.value }))} />
        </div>
        <div>
          <Label>RUT (Arrendatario)<span className="text-red-500">*</span></Label>
        ...
        <div>
          <Label>Encargado de pagos<span className="text-red-500">*</span></Label>
          <Input required name="encargadoPagos" onChange={e => setForm((f: any) => ({ ...f, encargadoPagos: e.target.value }))} />
        </div>
        <div>
          <Label>Correo electrónico encargado de pagos<span className="text-red-500">*</span></Label>
          <Input required name="correoEncargadoPagos" type="email" onChange={e => setForm((f: any) => ({ ...f, correoEncargadoPagos: e.target.value }))} />
        </div>
      </div>
    </>
  );
  ...
  const formNatural = (
    <>
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-xl font-heading font-semibold">Datos del Arrendatario (Persona Natural)</h2>
      </div>
      
      <div className="grid md:grid-cols-2 gap-4">
        <div>
          <Label>Nombre Completo (Arrendatario)<span className="text-red-500">*</span></Label>
        ...
        <div>
          <Label>Correo electrónico (Arrendatario)<span className="text-red-500">*</span></Label>
          <Input required name="correo" type="email" onChange={e => setForm((f: any) => ({ ...f, correo: e.target.value }))} />
        </div>
        <div>
          <Label>Teléfono<span className="text-red-500">*</span></Label>
  ...
  if (!tipo) {
    return (
      <div>
        <p className="mb-4 font-semibold">¿El arrendatario es persona jurídica?</p>
